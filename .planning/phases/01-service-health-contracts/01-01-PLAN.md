...
files-modified: [libs/common/common/health_contract.py, libs/common/common/logger.py, libs/common/common/models2/health.py, projects/web_api/tests/test_health_contract.py]
autonomous: true
objective: "Define and scaffold a shared service-health/readiness contract that core services can adopt without breaking endpoint compatibility."
requirements:
  - RELI-01
  - RELI-04
user_setup: []
